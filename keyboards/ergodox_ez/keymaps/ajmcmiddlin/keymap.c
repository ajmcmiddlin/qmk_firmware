...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT_ergodox(KC_EQUAL,KC_1,KC_2,KC_3,KC_4,KC_5,KC_ESCAPE,
                       KC_BSLASH,KC_Q,KC_W,KC_E,KC_R,KC_T,TT(2),
                       KC_TAB,KC_A,KC_S,KC_D,KC_F,KC_G,
                       KC_LSHIFT,CTL_T(KC_Z),KC_X,KC_C,KC_V,KC_B,MO(1),
                       ...
                       MO(1),KC_N,KC_M,KC_COMMA,KC_DOT,RCTL_T(KC_SLASH),KC_RSHIFT,
